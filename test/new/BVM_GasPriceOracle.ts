...
describe('test SequencerFeeValut', function () {
  ...
  it('should get balance before', async () => {
    ...
    const l2gpo = new ethers.Contract(
      "0x420000000000000000000000000000000000000F", 
      L2_BVM_GasPriceOracle_ABI.abi, 
      tr.SIGNERS.L2_Wallet
    )
    console.log(await l2gpo.l1BaseFee())
        
  })

  it.skip('should transfer to l2_BVM_SequencerFeeVault', async () => {
  ...
  it.skip('should get balance after transfer', async () => {
  ...
  it.skip('L2_BVM_SequencerFeeVault withdraw',async () => {
    tr.WITHDRAW_TX = await tr.CONTRACTS.L2_BVM_SequencerFeeVault.withdraw()

    console.log(tr.WITHDRAW_TX)
  })

  it.skip('should finalizeMessage is success', async () => {
    execSync('sleep 60');
  ...
  it.skip('should get balance after withdraw', async () => {

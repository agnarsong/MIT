...
export interface IDataLayrPaymentManagerInterface extends utils.Interface {
  functions: {
    ...
    "respondToPaymentChallengeFinal(address,uint256,uint48,bytes32[],(uint256,uint256),((bytes32,uint32,uint32,uint32,uint96,address,bytes32),uint8,uint256,uint32))": FunctionFragment;
...
export interface IDataLayrPaymentManager extends BaseContract {
  ...
  functions: {
    ...
    respondToPaymentChallengeFinal(
      ...
      totalStakes: IPaymentManager.TotalStakesStruct,
